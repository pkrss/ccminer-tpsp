...
{
	return _scanhash_yescrypt(thr_id, pdata, ptarget, max_nonce, hashes_done, 0);
}
	...
	unsigned long *hashes_done)
{
	...
	YESCRYPT_R = 16;
	YESCRYPT_P = 1;
	return _scanhash_yescrypt(thr_id, pdata, ptarget, max_nonce, hashes_done, 16);
}
	...
	unsigned long *hashes_done)
{
	...
	YESCRYPT_R = 32;
	YESCRYPT_P = 1;
	return _scanhash_yescrypt(thr_id, pdata, ptarget, max_nonce, hashes_done, 32);
}
